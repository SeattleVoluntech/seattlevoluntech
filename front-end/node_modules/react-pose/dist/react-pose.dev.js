(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('popmotion'), require('react')) :
    typeof define === 'function' && define.amd ? define(['exports', 'popmotion', 'react'], factory) :
    (factory((global.pose = {}),null,global.React));
}(this, (function (exports,popmotion,React) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var singleAxisPointer = function (axis) {
        return function (from) {
            var _a;
            return popmotion.pointer((_a = {}, _a[axis] = typeof from === 'string' ? parseFloat(from) : from, _a)).pipe(function (v) {
                return v[axis];
            });
        };
    };
    ...
    var createPassiveValue = function (init, parent, transform$$1) {
        var raw = popmotion.value(transform$$1(init));
    ...
    var linear$1 = popmotion.easing.linear,
        easeIn$1 = popmotion.easing.easeIn,
        easeOut$1 = popmotion.easing.easeOut,
        easeInOut$1 = popmotion.easing.easeInOut,
        circIn$1 = popmotion.easing.circIn,
        circOut$1 = popmotion.easing.circOut,
        circInOut$1 = popmotion.easing.circInOut,
        backIn$1 = popmotion.easing.backIn,
        backOut$1 = popmotion.easing.backOut,
        backInOut$1 = popmotion.easing.backInOut,
        anticipate$1 = popmotion.easing.anticipate;
    var easingLookup = {
        linear: linear$1,
        easeIn: easeIn$1,
        easeOut: easeOut$1,
    ...
    var index = memoize_cjs(function (prop) {
    ...
    var PoseElement = (function (_super) {
        ...
        function PoseElement(props) {
            ...
            _this.shouldForwardProp =
                typeof _this.props.elementType === 'string' ? index : testAlwaysTrue;
